      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="shrink-0 flex items-center">
            <Link :href="route('home')" class="flex gap-4 items-center">
        ...
        <div v-if="!$page.props.auth.user"  class="flex gap-4 items-center text-sm">
          <Link :href="route('login')" class="text-gray-500 hover:text-gray-600">Login</Link>
          <Link :href="route('register')" class="text-gray-500 hover:text-gray-600">Register</Link>
        </div>
      </div>
    </div>
